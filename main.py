...
def special(char_name, char_class):
    if char_class == 'warrior':
        return (
            f'{char_name} применил умение «Выносливость {80 + 25}»')
    if char_class == 'mage':
        return (
            f'{char_name} применил умение «Атака {5 + 40}»')
    if char_class == 'healer':
        return (
            f'{char_name} применил умение «Защита {10 + 30}»')
...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        char_class = input('Введи название персонаж:'
...
def choose_char_class():
    ...
    char_class = None
    while approve_choice != 'y':
        char_class = input('Выбери класс персонажа: '
                           'Воитель (warrior), Маг (mage), Лекарь (healer): ')
        if char_class == 'warrior':
